  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  // Initialize steady clock - FIXED: Use RCL_STEADY_TIME instead of rclcpp::ClockType::STEADY_TIME
  ...
  last_write_warning_time_ = std::chrono::steady_clock::now();  // Initialize this too
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  // Reset subscriber and node (not used in this implementation)
